...
3. Сделать отпрвку письма со ссылкой на подтверждение регистрации
...
if (isset($_POST) and $_SERVER["REQUEST_METHOD"]=="POST" 
	...
	if($conn->query($sql)) {
		...
		// $link = "<a href='http://ocean.local/registr.php?u_code=$u_code'>Confirm</a>";
                ...
                <div class="col-12">
                    ...
                    <form method="POST">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <input type="phone" class="form-control" name="usphone" placeholder="Phone Number">
                            </div>
                            <div class="col-lg-6">
                                <input type="email" class="form-control" name="usmail" placeholder="E-mail">
                            </div>
                            <div class="col-lg-6">
